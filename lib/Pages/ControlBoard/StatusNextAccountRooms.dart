...
import 'package:celebration/Component/Widget/StatusCustomAlertDialog.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';

class StatusNextAccountRooms extends StatefulWidget {
  @override
  _StatusNextAccountRoomsState createState() => _StatusNextAccountRoomsState();
}

class _StatusNextAccountRoomsState extends State<StatusNextAccountRooms> {
  bool select;
  ...
  void _newAccountSave(){
    Navigator.pop(context);
  }
  void _newAccountEdit(){
    showDialog(
      context: context,
      builder: (_) => StatusCustomAlertDialog(
        mess: 'يرجى العلم انه بتغير الصور ستخضع القاعه لتوقف مؤقت لحين تتم الموافقه على الصور الجديده',
      ),
    );
  }
