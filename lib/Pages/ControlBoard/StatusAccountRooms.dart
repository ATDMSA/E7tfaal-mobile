...
import 'package:celebration/Pages/ControlBoard/StatusNextAccountRooms.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:location/location.dart';
class StatusAccountRooms extends StatefulWidget {
  final String name;
  StatusAccountRooms({this.name});
  @override
  _StatusAccountRoomsState createState() => _StatusAccountRoomsState();
}

class _StatusAccountRoomsState extends State<StatusAccountRooms> {
  ...
  void _newAccount(){
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>StatusNextAccountRooms()));
  }
