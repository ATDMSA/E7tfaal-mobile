...
import 'package:celebration/Pages/Auth/Drawers/AboutUs.dart';
import 'package:celebration/Pages/Auth/Drawers/CelebrationHalls.dart';
import 'package:celebration/Pages/Auth/Drawers/ProfilePage.dart';
import 'package:celebration/Pages/Auth/Drawers/Promotion.dart';
import 'package:celebration/Pages/Auth/Drawers/Reservation.dart';
import 'package:celebration/Pages/Auth/Drawers/Notification.dart';
import 'package:celebration/Pages/Auth/Drawers/Support.dart';
    ...
    return InkWell(
      onTap: (){
        if ( index == 0){
          ...
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>SpecialRooms(title: LocalKeys.SpecialRoomsFAVORIT,)));
        }else if(index == 4){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>NotificationPage()));
        }else if(index == 5 || index == 6){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>AboutUs(title: index == 5 ? 'من نحن':'الشروط والأحكام',)));
        }else if(index == 7){
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Promotion()));
        }else if(index == 8){
