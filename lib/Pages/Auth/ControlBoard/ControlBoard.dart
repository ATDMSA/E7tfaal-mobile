...
import 'package:celebration/Pages/Auth/ControlBoard/BankAccounts.dart';
import 'package:celebration/Pages/Auth/ControlBoard/CanceledReservations.dart';
import 'package:celebration/Pages/Auth/ControlBoard/OffersPage.dart';
import 'package:celebration/Pages/Auth/ControlBoard/PayTheSubscriptionFees.dart';
import 'package:celebration/Pages/Auth/ControlBoard/PendingReservations.dart';
import 'package:celebration/Pages/Auth/ControlBoard/ReservationsReceived.dart';
import 'package:celebration/Pages/Auth/ControlBoard/SubscriptionStatus.dart';
    ...
    return InkWell(
      onTap: (){
        if ( index == 0){
          ...
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>PayTheSubscriptionFees()));
        }else if(index == 5){
